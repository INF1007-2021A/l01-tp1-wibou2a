...
def calculerPosition(positionInitiale, vitesseInitiale, duree, vitesseFinale):
    ...
    positionFinale = vitesseInitiale/3.6 * duree * (1/2) * acceleration * duree**2
...
if __name__ == '__main__':
    ...
    print("La position finale est " , calculerPosition(positionInitiale, vitesseInitiale, duree, vitesseFinale), "mètres")
